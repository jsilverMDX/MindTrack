...
?>
  <div id="<?= $project['name']; ?>-name"><? echo($project['name']); ?></div>
<? endforeach; ?>
</ul>
...
?>
  ...
  <div class="project-timestamps"><div class="project-created">Started: <?= $this->Time->timeAgoInWords($project['created']); ?> (<?= $this->Time->niceShort($project['created']); ?>)</div><div class="project-updated">Updated: <?= $this->Time->timeAgoInWords($project['updated']); ?> (<?= $this->Time->niceShort($project['updated']); ?>)</div></div>
